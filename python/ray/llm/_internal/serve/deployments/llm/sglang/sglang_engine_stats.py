...
if TYPE_CHECKING:
    from sglang.outputs import RequestOutput


engine_metrics_prefix = "sglang_engine_stats"
...
usage_metrics_prefix = "sglang_arg_usage_stats"
...
class SGLANGEngineStats(BaseModel):
...
class SGLANGEngineStatTracker:
    ...
    def to_stats(self) -> SGLANGEngineStats:
        return SGLANGEngineStats(
...
class RequestStateTracker:
    ...
    def __init__(self, global_stats: SGLANGEngineStatTracker):
